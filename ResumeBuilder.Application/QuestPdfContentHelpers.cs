...
{
    private static readonly ImmutableDictionary<Theme, string> ThemeColors =
        ImmutableDictionary.CreateRange(new Dictionary<Theme, string>
        {
    ...
    public static ImmutableDictionary<Theme, string> GetThemeColors() => ThemeColors;
